...
export default {
  ...
  data() {
    return {
      lines: [
        [
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max1' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max2' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max3' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max4' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max5' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max6' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max7' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max8' },
        ],
        [
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max9' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max10' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max11' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max12' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max13' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max14' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max15' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max16' },
        ],
        [
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max17' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max18' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max19' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max20' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max21' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max22' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max23' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max24' },
        ],
        [
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max25' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max26' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max27' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max28' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max29' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max30' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max31' },
          { imgSrc: `${pubUse.getAssetsFile('Air_Max.png')}`, title: 'Apple Air_Max32' },
        ],
      ],
    };
  },
